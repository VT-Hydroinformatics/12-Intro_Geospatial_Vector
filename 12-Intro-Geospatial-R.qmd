...
# Display the saved HTML file content in the notebook output
# This method reads the HTML file and prints its content, allowing the notebook
# environment to render the interactive map.
library(htmltools)
includeHTML(usa_tmap_interactive_fp)
