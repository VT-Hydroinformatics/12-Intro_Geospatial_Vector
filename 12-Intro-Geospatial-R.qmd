...
::: {#fig-raster-vector1 .captioned-figure}
<img src="./images/raster-vector1.png" alt="Raster vs. Vector 1" width="1000">

Raster vs. Vector 1
:::

::: {#fig-raster-vector2 .captioned-figure}
<img src="./images/raster-vector2.png" alt="Raster vs. Vector 2" width="1000">
...
tmap_plot_interactive_fp <- "./images/tmap_plot.html"
tmap_plot_static_fp <- "./images/tmap_plot.png"
...
tmap_plot <- usa + tm_basemap(server = "OpenTopoMap")

tmap_plot |> tmap_save(tmap_plot_interactive_fp)
webshot(url = tmap_plot_interactive_fp,file = tmap_plot_static_fp,cliprect = "viewport")
```


::: {#fig-tmap-plot .captioned-figure}
<img src="./images/tmap_plot.png" alt="Tmap plot" width="1000">

Screenshot of Tmap plot. View the **[interactive map here](./images/tmap_plot.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
leaflet_plot_interactive_fp <- "./images/leaflet_plot.html"
leaflet_plot_static_fp <- "./images/leaflet_plot.png"

# Assign the leaflet plot to a variable
leaflet_plot <- leaflet(watersheds_info) |>
  addTiles() |>
  addPolygons(color = "#444444", weight = 1, smoothFactor = 0.5,
    opacity = 1.0, fillOpacity = 0.5,
    fillColor = ~colorQuantile("YlOrRd", elev_mean)(elev_mean))

leaflet_plot |> htmlwidgets::saveWidget(leaflet_plot_interactive_fp)
webshot(url = leaflet_plot_interactive_fp,file = leaflet_plot_static_fp,cliprect = "viewport")
```

::: {#fig-leaflet-plot .captioned-figure}
<img src="./images/leaflet_plot.png" alt="Leaflet plot" width="1000">

Screenshot of Leaflet plot. View the **[interactive map here](./images/leaflet_plot.html)**. 
:::