...
usa_tmap_interactive_fp <- "./images/tmap.html"
usa_tmap_static_fp <- "./images/tmap.png"
...
usa + tm_basemap(server = "OpenTopoMap") |> 
  tmap_leaflet() |>
  mapshot(url=usa_tmap_interactive_fp,file=usa_tmap_static_fp)

```

::: {#fig-tmap-plot .captioned-figure}
<img src="./images/tmap_static.png" alt="Tmap plot" width="1000">

Screenshot of Tmap plot. View the **[interactive map here](./images/leaflet.html)**. 
:::
...
```{r}
# define where to save static and interactive maps
leaflet_interactive_fp <- "./images/leaflet.html"
leaflet_static_fp <- "./images/leaflet.png"
...
leaflet(watersheds_info) |>
  ...
  mapshot(url=leaflet_interactive_fp,file=leaflet_static_fp)
```

::: {#fig-leaflet-plot .captioned-figure}
<img src="./images/leaflet.png" alt="Leaflet plot" width="1000">

Screenshot of Leaflet plot. View the **[interactive map here](./images/leaflet.html)**. 
:::