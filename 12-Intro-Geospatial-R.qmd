...
```{figure} https://github.com/abnerbog/12-Intro_Geospatial_Vector/blob/master/images/tmap_interactive.html
:name: tmap-fig
:align: center
```
...
```{figure} https://github.com/abnerbog/12-Intro_Geospatial_Vector/blob/master/images/leaflet_interactive.html
:name: leaflet-fig
:align: center
```